        ...
        <Navbar expand="lg" className="custom-navbar shadow-sm fixed-top">
            <Container>
                ...
                <Nav className="me-auto">
                    ...
                    <Nav.Link as={Link} to="/find" active={location.pathname === "/"}>
                        Căn Hộ
                    </Nav.Link>
                    {userRole === "User" && (
                        <>
                            <Nav.Link as={Link} to="/view-payment" active={location.pathname === "/transactions"}>
                                Thanh toán
                                <Nav.Link as={Link} to="/profile/transactions" active={location.pathname === "/transactions"}>
                                    Giao Dịch
                                </Nav.Link>
                                <Nav.Link as={Link} to="/service" active={location.pathname === "/services"}>
                                    Dịch Vụ
                                </Nav.Link>
                            </>
                    )}
