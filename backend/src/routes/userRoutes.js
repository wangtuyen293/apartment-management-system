...
import { banAccount, changePassword, deleteUserByUserId, getAllUsers, getUserProfile, updateUserProfile, updateUserRole, uploadAvatar } from "../controllers/usersController.js";
...
router.delete("/:userId", protect, adminAuth, deleteUserByUserId);
